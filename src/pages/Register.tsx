...
import { LogInButton, ButtonContainer, RegistrationWrapper, LogRegCont, ErrorMessage } from '../styles';
        ...
        <RegistrationWrapper>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div id='regInfo'>
              <div>
                <label>Name</label>
                <input {...register("name", {required: true})} onChange={(e) => {
            ...
            <div>
              <label>ARN</label>
              <input {...register("arn", {required: true})} onChange={(e) => {
            ...
            <label htmlFor="region">Choose your region:</label><br></br>
            <select
              required
              id="region"
              name="region"
